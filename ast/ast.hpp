...
/*!	
  ...
  \note  ConstantNode Class publicly inherits from ExpNode class
*/
class LogicalConstantNode : public ConstantNode 
{
	public:
	...
	/*!		
		...
		\post  A new ConstantNode is created with the name of the parameter
	*/
	  LogicalConstantNode(std::string value) : ConstantNode(value)
		{
...
/*!	
  ...
  \note  ConstantNode Class publicly inherits from ExpNode class
*/
class NumericConstantNode : public ConstantNode 
{
	public:
	...
	/*!		
		...
		\post  A new ConstantNode is created with the name of the parameter
	*/
	  NumericConstantNode(std::string value) : ConstantNode(value)
		{
...
class StringConstantNode : public ConstantNode 
{
	...
	/*!		
		...
		\post  A new ConstantNode is created with the name of the parameter
	*/
	  StringConstantNode(std::string value) : ConstantNode(value)
		{
...
/*!	
  \class  IncrementNode
  \brief   Definition of atributes and methods ofIncrementStmt class
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class IncrementNode : public ExpNode
{
...
*/
 	IncrementNode(std::string id, int typeOp)
	{
		this->_id = id;
		this->_typeOp = typeOp;
	} 
...
/*!	
  \class  DecrementNode
  \brief   Definition of atributes and methods ofDecrementStmt class
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class DecrementNode : public ExpNode
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
 	DecrementNode(std::string id, int typeOp)
	{
		this->_id = id;
		this->_typeOp = typeOp;
	} 
...
/*!	
  ...
  \note    ConcatenationNode Class publicly inherits from NumericOperatorNode class 
		   and adds its own printAST and evaluate functions
*/
class ConcatenationNode : public StringOperatorNode 
{
  public:
/*!		
	\brief Constructor of ConcatenationNode uses NumericOperatorNode's constructor as members initializer
	\param L: pointer to ExpNode
	\param R: pointer to ExpNode
...
/*!	
  ...
  \note    AssignmentStmt Class publicly inherits from Statement class 
		   and adds its own printAST and evaluate functions
*/
class NumericOperatorAssignmentStmt : public AssignmentStmt 
{
 public:
/*!		
	\brief Constructor of AssignmentStmt 
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  NumericOperatorAssignmentStmt(std::string id, ExpNode *expression): AssignmentStmt(id, expression)
	{
...
*/
  ...
  NumericOperatorAssignmentStmt(std::string id, AssignmentStmt *asgn): AssignmentStmt(id, asgn)
	{
...
/*!	
  ...
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class PlusAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  PlusAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  PlusAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  ...
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class MinusAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  MinusAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  MinusAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  ...
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class MultiplicationAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  MultiplicationAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  MultiplicationAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  \class   PowerAssignmentStmt
  \brief   Definition of atributes and methods of PowerAssignmentStmt class
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class PowerAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  PowerAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  PowerAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  \class   IntegerDivisionAssignmentStmt
  \brief   Definition of atributes and methods of IntegerDivisionAssignmentStmt class
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class IntegerDivisionAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  IntegerDivisionAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  IntegerDivisionAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  ...
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class DivisionAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  DivisionAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  DivisionAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  \class   ModuloAssignmentStmt
  \brief   Definition of atributes and methods of ModuloAssignmentStmt class
  \note    AssignmentStmt Class publicly inherits from NumericOperatorAssignmentStmt class 
		   and adds its own printAST and evaluate functions
*/
class ModuloAssignmentStmt : public NumericOperatorAssignmentStmt 
{
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  ModuloAssignmentStmt(std::string id, ExpNode *expression): NumericOperatorAssignmentStmt(id, expression)
	{
		//this->_asgn = NULL; 
	}
...
*/
  ...
  ModuloAssignmentStmt(std::string id, AssignmentStmt *asgn): NumericOperatorAssignmentStmt(id, asgn)
	{
		//this->_exp = NULL;
	}
...
/*!	
  \class   ConstAssignmentStmt
  \brief   Definition of atributes and methods of AssignmentStmt class
  \note    AssignmentStmt Class publicly inherits from Statement class 
		   and adds its own printAST and evaluate functions
*/
class ConstAssignmentStmt : public AssignmentStmt 
{
/*  private:
  std::string _id; //!< Name of the variable of the assignment statement
  ExpNode *_exp; 	 //!< Expresssion the assignment statement

  ConstAssignmentStmt *_asgn;  //!< Allow multiple assigment -> a = b = 2  */
...
/*!		
	...
	\post  A new AssignmentStmt is created with the parameters
*/
  ConstAssignmentStmt(std::string id, ExpNode *expression): AssignmentStmt(id, expression)
	{
		this->_asgn = NULL; 
	}
...
*/
  ...
  ConstAssignmentStmt(std::string id, ConstAssignmentStmt *asgn): AssignmentStmt(id, asgn)
	{
		this->_exp = NULL;
	}
...
{
 private:
  ExpNode *_cond;    //!< Condicion of the Case statement
  /* std::map<int, std::list<Statement *> > *_values;
  std::map<std::string, std::list<Statement *> > *_valuesCad;   */
  std::list<Statement *> *_defaultCase;
  struct values *_caseValues;
...
*/
 	CaseStmt(ExpNode *condition,  struct values *caseValues, std::list<Statement *> *defaultCase)
	{
		this->_cond = condition;
...
class DoWhileStmt : public Statement 
{
 private:
  ...
  std::list<Statement *> *_stmts; //!< Statement of the body of the DoWhile loop
...
*/
  DoWhileStmt(ExpNode *condition, std::list<Statement *> *statements)
	{
		this->_cond = condition;
		this->_stmts = statements;
	}
...
{
 private:
  std::string _id; //!< Condicion of the while statement
  ExpNode *_from;
  ExpNode *_to;
  ExpNode *_step;
  std::list<Statement *> *_stmts; //!< Statement of the body of the repeat loop
...
/*!		
	...
	\post  A new RepeatStmt is created with the parameters
*/
  ForStmt(std::string id, ExpNode *from, ExpNode *to, ExpNode *step, std::list<Statement *> *statements)
  {
		this->_id = id;
		this->_from = from;
		this->_to = to;
  ...
  ForStmt(std::string id, ExpNode *from, ExpNode *to, std::list<Statement *> *statements)
  {
		this->_id = id;
		this->_from = from;
		this->_to = to;
...
/*!	
  ...
  \note    StyleStmt Class publicly inherits from Statement class 
		       and adds its own printAST and evaluate functions
*/
class StyleStmt : public Statement 
{
  ...
  StyleStmt(std::string style)
  {
	this->_style = style;
  }
/*!
	\brief   Print the AST StyleStmt
	\return  void
	\sa		   evaluate
*/
  void printAST();
